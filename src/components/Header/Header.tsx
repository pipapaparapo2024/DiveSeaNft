    ...
    <header className={classNames(styles.header, { [styles.scrolled]: scrolled })}>
      <div className={styles.logo}>
        <svg viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
          ...
          <path d="M2 16C2 16 5 12 12 12C19 12 22 16 22 16" stroke="currentColor" strokeWidth="2" strokeLinecap="round"/>
          <path d="M2 8C2 8 5 4 12 4C19 4 22 8 22 8" stroke="currentColor" strokeWidth="2" strokeLinecap="round"/>
        </svg>
        <span>DiveSea</span>
      </div>
